...
--------------------------------------------------------
 ...
 XMLTYPE COLUMN "LITE_XML" STORE AS SECUREFILE BINARY XML "LITE_XML_DATA"(DISABLE STORAGE IN ROW CHUNK 8192
  ...
  GRANT SELECT ON "SPIREMGR"."SITE_DETAILS" TO "BISAPIMGR";
  GRANT SELECT ON "SPIREMGR"."SITE_DETAILS" TO "APPENV";
  GRANT REFERENCES ON "SPIREMGR"."SITE_DETAILS" TO "XVIEWMGR";
  GRANT SELECT ON "SPIREMGR"."SITE_DETAILS" TO "BPMMGR";
