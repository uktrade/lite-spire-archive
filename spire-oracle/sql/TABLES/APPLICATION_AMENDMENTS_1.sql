...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "SDBPUBMGR"."APPLICATION_AMENDMENTS" TO "SDBMGR";
  GRANT SELECT ON "SDBPUBMGR"."APPLICATION_AMENDMENTS" TO "SDBMGR";
  GRANT INSERT ON "SDBPUBMGR"."APPLICATION_AMENDMENTS" TO "SDBMGR";
