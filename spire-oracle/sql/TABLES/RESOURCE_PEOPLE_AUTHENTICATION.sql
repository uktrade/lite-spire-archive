...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "DECMGR"."RESOURCE_PEOPLE_AUTHENTICATION" TO "SECUREMGR";
  GRANT INSERT ON "DECMGR"."RESOURCE_PEOPLE_AUTHENTICATION" TO "SECUREMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_PEOPLE_AUTHENTICATION" TO "SECUREMGR";
