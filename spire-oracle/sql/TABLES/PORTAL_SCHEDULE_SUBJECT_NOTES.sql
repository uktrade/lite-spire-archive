...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "DECMGR"."PORTAL_SCHEDULE_SUBJECT_NOTES" TO "APPENV";
  GRANT INSERT ON "DECMGR"."PORTAL_SCHEDULE_SUBJECT_NOTES" TO "APPENV";
  GRANT SELECT ON "DECMGR"."PORTAL_SCHEDULE_SUBJECT_NOTES" TO "APPENV";
