--------------------------------------------------------
--  DDL for Table XVIEW_DEFINITIONS_5
--------------------------------------------------------

  CREATE TABLE "SAVEMGR"."XVIEW_DEFINITIONS_5" 
   ...
   COMMENT ON TABLE "SAVEMGR"."XVIEW_DEFINITIONS_5"  IS 'Save of "XVIEWMGR"."XVIEW_DEFINITIONS" at 17-SEP-2009 19:28:42';
  GRANT SELECT ON "SAVEMGR"."XVIEW_DEFINITIONS_5" TO "XVIEWMGR";
