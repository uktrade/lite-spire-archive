...
;
  GRANT SELECT ON "DECMGR"."RESOURCE_MEMBER_CURRENT_SIMPLE" TO "SPIREMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_MEMBER_CURRENT_SIMPLE" TO "SECUREMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_MEMBER_CURRENT_SIMPLE" TO "ENVMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_MEMBER_CURRENT_SIMPLE" TO "BPMMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_MEMBER_CURRENT_SIMPLE" TO "APPENV";
