...
;
  GRANT SELECT ON "SPIREMGR"."SPIRE_APPLICANTS_OU_MERGE" TO "PVEXMGR";
  GRANT SELECT ON "SPIREMGR"."SPIRE_APPLICANTS_OU_MERGE" TO "BISAPIMGR";
  GRANT SELECT ON "SPIREMGR"."SPIRE_APPLICANTS_OU_MERGE" TO "BPMMGR";
  GRANT SELECT ON "SPIREMGR"."SPIRE_APPLICANTS_OU_MERGE" TO "APPENV";
