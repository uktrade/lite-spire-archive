--------------------------------------------------------
--  DDL for Table XVIEW_DEFINITIONS_3
--------------------------------------------------------

  CREATE TABLE "SAVEMGR"."XVIEW_DEFINITIONS_3" 
   ...
   COMMENT ON TABLE "SAVEMGR"."XVIEW_DEFINITIONS_3"  IS 'Save of "XVIEWMGR"."XVIEW_DEFINITIONS" at 07-MAR-2008 18:59:50';
  GRANT SELECT ON "SAVEMGR"."XVIEW_DEFINITIONS_3" TO "XVIEWMGR";
