...
;
  GRANT SELECT ON "BPMMGR"."XVIEW_INTENTION_SETS" TO "BISAPIMGR";
  GRANT SELECT ON "BPMMGR"."XVIEW_INTENTION_SETS" TO "PVEXMGR";
  GRANT SELECT ON "BPMMGR"."XVIEW_INTENTION_SETS" TO "APPENV";
  GRANT SELECT ON "BPMMGR"."XVIEW_INTENTION_SETS" TO "SPIREMGR";
