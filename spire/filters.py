...
class LicenceFilterSet(django_filters.rest_framework.FilterSet):
    organisation = django_filters.CharFilter(
        field_name="licence_detail_set__application_detail__"
        "applicant__applicant_detail_set__organisation_unit",
        lookup_expr="exact",
    )
    part_no = django_filters.CharFilter(
        field_name="licence_detail_set__application_detail__"
        "application__control_list_good_set__part_no",
        lookup_expr="exact",
    )
    description = django_filters.CharFilter(
        field_name="licence_detail_set__application_detail__"
        "application__control_list_good_set__description",
