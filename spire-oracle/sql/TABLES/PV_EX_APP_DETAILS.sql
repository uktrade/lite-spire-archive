...
--------------------------------------------------------
 ...
 XMLTYPE COLUMN "XML_DATA" STORE AS SECUREFILE BINARY XML "PEA_DETAILS_XML_DATA"(DISABLE STORAGE IN ROW CHUNK 8192
  ...
  GRANT REFERENCES ON "PVEXMGR"."PV_EX_APP_DETAILS" TO "XVIEWMGR";
  GRANT SELECT ON "PVEXMGR"."PV_EX_APP_DETAILS" TO "BPMMGR";
  GRANT UPDATE ON "PVEXMGR"."PV_EX_APP_DETAILS" TO "APPENV";
  GRANT SELECT ON "PVEXMGR"."PV_EX_APP_DETAILS" TO "APPENV";
