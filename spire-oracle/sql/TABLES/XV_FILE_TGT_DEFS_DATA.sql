...
--------------------------------------------------------
  ...
  GRANT SELECT ON "XVIEWMGR"."XV_FILE_TGT_DEFS_DATA" TO "SPMIGUSER" WITH GRANT OPTION;
  GRANT SELECT ON "XVIEWMGR"."XV_FILE_TGT_DEFS_DATA" TO "DECMGR" WITH GRANT OPTION;
