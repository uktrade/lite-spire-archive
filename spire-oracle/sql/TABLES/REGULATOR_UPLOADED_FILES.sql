...
--------------------------------------------------------
 ...
 XMLTYPE COLUMN "XML_DATA" STORE AS BASICFILE CLOB "REGULATOR_UPLOADS_XML"(ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  CACHE ) ;
  GRANT UPDATE ON "SECUREMGR"."REGULATOR_UPLOADED_FILES" TO "APPENV";
  GRANT SELECT ON "SECUREMGR"."REGULATOR_UPLOADED_FILES" TO "APPENV";
  GRANT INSERT ON "SECUREMGR"."REGULATOR_UPLOADED_FILES" TO "APPENV";
  GRANT DELETE ON "SECUREMGR"."REGULATOR_UPLOADED_FILES" TO "APPENV";
