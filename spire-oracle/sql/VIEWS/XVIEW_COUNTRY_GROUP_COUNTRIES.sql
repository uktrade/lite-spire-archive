...
;
  GRANT SELECT ON "BPMMGR"."XVIEW_COUNTRY_GROUP_COUNTRIES" TO "BISAPIMGR";
  GRANT SELECT ON "BPMMGR"."XVIEW_COUNTRY_GROUP_COUNTRIES" TO "SPIREMGR";
  GRANT SELECT ON "BPMMGR"."XVIEW_COUNTRY_GROUP_COUNTRIES" TO "APPENV";
