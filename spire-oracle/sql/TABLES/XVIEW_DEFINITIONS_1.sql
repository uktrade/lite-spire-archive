--------------------------------------------------------
--  DDL for Table XVIEW_DEFINITIONS_1
--------------------------------------------------------

  CREATE TABLE "SAVEMGR"."XVIEW_DEFINITIONS_1" 
   ...
   COMMENT ON TABLE "SAVEMGR"."XVIEW_DEFINITIONS_1"  IS 'Save of "XVIEWMGR"."XVIEW_DEFINITIONS" at 24-FEB-2008 14:01:53';
  GRANT SELECT ON "SAVEMGR"."XVIEW_DEFINITIONS_1" TO "XVIEWMGR";
