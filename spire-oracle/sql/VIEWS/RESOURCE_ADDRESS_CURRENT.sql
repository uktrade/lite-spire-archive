...
;
  GRANT SELECT ON "DECMGR"."RESOURCE_ADDRESS_CURRENT" TO "PVEXMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_ADDRESS_CURRENT" TO "BISAPIMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_ADDRESS_CURRENT" TO "SPIREMGR";
  GRANT SELECT ON "DECMGR"."RESOURCE_ADDRESS_CURRENT" TO "APPENV";
