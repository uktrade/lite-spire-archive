...
--------------------------------------------------------
  ...
  GRANT INSERT ON "DECMGR"."PORTAL_FOLDER_ITEMS" TO "BPMMGR";
  GRANT SELECT ON "DECMGR"."PORTAL_FOLDER_ITEMS" TO "FOXMGR";
  GRANT SELECT ON "DECMGR"."PORTAL_FOLDER_ITEMS" TO "APPENV";
