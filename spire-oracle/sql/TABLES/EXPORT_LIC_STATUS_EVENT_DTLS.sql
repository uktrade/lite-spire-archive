...
--------------------------------------------------------
  ...
  GRANT SELECT ON "SPIREMGR"."EXPORT_LIC_STATUS_EVENT_DTLS" TO "SDBMGR";
  GRANT SELECT ON "SPIREMGR"."EXPORT_LIC_STATUS_EVENT_DTLS" TO "BPMMGR";
  GRANT SELECT ON "SPIREMGR"."EXPORT_LIC_STATUS_EVENT_DTLS" TO "APPENV";
