--------------------------------------------------------
--  DDL for Table XVIEW_DEFINITIONS_2
--------------------------------------------------------

  CREATE TABLE "SAVEMGR"."XVIEW_DEFINITIONS_2" 
   ...
   COMMENT ON TABLE "SAVEMGR"."XVIEW_DEFINITIONS_2"  IS 'Save of "XVIEWMGR"."XVIEW_DEFINITIONS" at 24-FEB-2008 14:07:15';
  GRANT SELECT ON "SAVEMGR"."XVIEW_DEFINITIONS_2" TO "XVIEWMGR";
