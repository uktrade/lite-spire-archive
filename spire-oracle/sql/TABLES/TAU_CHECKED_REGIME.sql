...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "SPIREMGR"."TAU_CHECKED_REGIME" TO "APPENV";
  GRANT SELECT ON "SPIREMGR"."TAU_CHECKED_REGIME" TO "APPENV";
  GRANT INSERT ON "SPIREMGR"."TAU_CHECKED_REGIME" TO "APPENV";
