...
;
  GRANT SELECT ON "PORTALMGR"."WEB_USER_SESSIONS" TO "SECUREMGR";
  GRANT SELECT ON "PORTALMGR"."WEB_USER_SESSIONS" TO "FOXMGR";
  GRANT SELECT ON "PORTALMGR"."WEB_USER_SESSIONS" TO "ENVMGR";
  GRANT SELECT ON "PORTALMGR"."WEB_USER_SESSIONS" TO "APPENV";
