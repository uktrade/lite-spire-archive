...
--------------------------------------------------------
  ...
  GRANT REFERENCES ON "BPMMGR"."ADVICE_TYPES" TO "SPIREMGR";
  GRANT SELECT ON "BPMMGR"."ADVICE_TYPES" TO "SPIREMGR";
  GRANT REFERENCES ON "BPMMGR"."ADVICE_TYPES" TO "XVIEWMGR";
  GRANT SELECT ON "BPMMGR"."ADVICE_TYPES" TO "APPENV";
