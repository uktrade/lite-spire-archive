...
--------------------------------------------------------
  ...
  CREATE TABLE "SAVEMGR"."XVIEW_DEFINITIONS" 
   ...
   COMMENT ON TABLE "SAVEMGR"."XVIEW_DEFINITIONS"  IS 'Save of "XVIEWMGR"."XVIEW_DEFINITIONS" at 07-FEB-2008 20:07:35';
  GRANT SELECT ON "SAVEMGR"."XVIEW_DEFINITIONS" TO "XVIEWMGR";
