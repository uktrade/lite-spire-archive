...
--------------------------------------------------------
  ...
  GRANT SELECT ON "BPMMGR"."REVIEW_INVITATION_DETAILS" TO "SPIREMGR";
  GRANT REFERENCES ON "BPMMGR"."REVIEW_INVITATION_DETAILS" TO "XVIEWMGR";
  GRANT SELECT ON "BPMMGR"."REVIEW_INVITATION_DETAILS" TO "APPENV";
