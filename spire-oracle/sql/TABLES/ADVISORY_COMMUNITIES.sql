...
--------------------------------------------------------
  ...
  GRANT REFERENCES ON "BPMMGR"."ADVISORY_COMMUNITIES" TO "SPIREMGR";
  GRANT SELECT ON "BPMMGR"."ADVISORY_COMMUNITIES" TO "SPIREMGR";
  GRANT SELECT ON "BPMMGR"."ADVISORY_COMMUNITIES" TO "APPENV";
