--------------------------------------------------------
--  DDL for Table XVIEW_DEFINITIONS
--------------------------------------------------------

  CREATE TABLE "XVIEWMGR"."XVIEW_DEFINITIONS" 
   (	"XVIEW_OWNER" VARCHAR2(30 BYTE), 
	"XVIEW_NAME" VARCHAR2(30 BYTE), 
	"PROCESS_WHEN" VARCHAR2(17 BYTE) DEFAULT 'IN TRANSACTION', 
	"PROCESS_KEYS" VARCHAR2(12 BYTE) DEFAULT 'IN MEMORY', 
	"PROCESS_HOW" VARCHAR2(11 BYTE) DEFAULT 'MERGE DIFFS', 
	"ENTER_COMMAND_HERE" VARCHAR2(10 BYTE), 
	"LAST_STATUS" VARCHAR2(12 BYTE) DEFAULT 'NOT CREATED', 
