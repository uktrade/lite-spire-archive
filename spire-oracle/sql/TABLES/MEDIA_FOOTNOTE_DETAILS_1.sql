...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "SDBPUBMGR"."MEDIA_FOOTNOTE_DETAILS" TO "SDBMGR";
  GRANT SELECT ON "SDBPUBMGR"."MEDIA_FOOTNOTE_DETAILS" TO "SDBMGR";
  GRANT INSERT ON "SDBPUBMGR"."MEDIA_FOOTNOTE_DETAILS" TO "SDBMGR";
  GRANT SELECT ON "SDBPUBMGR"."MEDIA_FOOTNOTE_DETAILS" TO "APPENV";
