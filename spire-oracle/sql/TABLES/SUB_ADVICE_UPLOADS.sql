...
--------------------------------------------------------
 ...
 XMLTYPE COLUMN "FILE_METADATA_XML" STORE AS SECUREFILE BINARY XML "SUB_ADVICE_XML_METADATA"(DISABLE STORAGE IN ROW CHUNK 8192
  ...
  GRANT UPDATE ON "PVEXMGR"."SUB_ADVICE_UPLOADS" TO "APPENV";
  GRANT SELECT ON "PVEXMGR"."SUB_ADVICE_UPLOADS" TO "APPENV";
  GRANT INSERT ON "PVEXMGR"."SUB_ADVICE_UPLOADS" TO "APPENV";
