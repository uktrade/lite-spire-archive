...
;
  GRANT SELECT ON "DECMGR"."ORGANISATION_ADDRESS_DETAILS" TO "BISAPIMGR";
  GRANT SELECT ON "DECMGR"."ORGANISATION_ADDRESS_DETAILS" TO "BPMMGR";
  GRANT SELECT ON "DECMGR"."ORGANISATION_ADDRESS_DETAILS" TO "SPIREMGR" WITH GRANT OPTION;
  GRANT SELECT ON "DECMGR"."ORGANISATION_ADDRESS_DETAILS" TO "APPENV";
