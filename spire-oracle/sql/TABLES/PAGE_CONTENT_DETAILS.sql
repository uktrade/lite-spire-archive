...
--------------------------------------------------------
 ...
 XMLTYPE COLUMN "XML_DATA" STORE AS BASICFILE CLOB "PCD_XML"(ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  CACHE ) ;
  GRANT REFERENCES ON "DECMGR"."PAGE_CONTENT_DETAILS" TO "XVIEWMGR";
  GRANT UPDATE ON "DECMGR"."PAGE_CONTENT_DETAILS" TO "APPENV";
  GRANT SELECT ON "DECMGR"."PAGE_CONTENT_DETAILS" TO "APPENV";
  GRANT INSERT ON "DECMGR"."PAGE_CONTENT_DETAILS" TO "APPENV";
