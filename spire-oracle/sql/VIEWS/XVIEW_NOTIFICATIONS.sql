...
;
  GRANT SELECT ON "DECMGR"."XVIEW_NOTIFICATIONS" TO "BISAPIMGR";
  GRANT SELECT ON "DECMGR"."XVIEW_NOTIFICATIONS" TO "SPIREMGR";
  GRANT SELECT ON "DECMGR"."XVIEW_NOTIFICATIONS" TO "BPMMGR";
  GRANT SELECT ON "DECMGR"."XVIEW_NOTIFICATIONS" TO "APPENV";
