...
--------------------------------------------------------
  ...
  GRANT UPDATE ON "DECMGR"."ORGANISATION_GROUP_TYPES" TO "APPENV";
  GRANT SELECT ON "DECMGR"."ORGANISATION_GROUP_TYPES" TO "APPENV";
  GRANT INSERT ON "DECMGR"."ORGANISATION_GROUP_TYPES" TO "APPENV";
